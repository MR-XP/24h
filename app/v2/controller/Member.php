...
use app\v2\model\UserModel;
use app\v2\model\MemberCards;
...
class Member extends Base {
    ...
    public function getUserCourse() {
        ...
        $list = (new \app\v2\model\MemberCourseModel())->get_my_course_list($this->merchant['mch_id'],$data);
        return success($list);
    }
    /**
     * 用户的会员卡详情
    ...
    public function getCardInfo() {
        ...
        $limit = input('limit',0);
        $model = new MemberCardModel();
        $card_info = $model->get_card_info($this->merchant['mch_id'], $this->user['user_id'], $data,$limit);
    ...
    public function bindCardUser() {
        ...
        $User = new \app\v2\model\UserModel();
