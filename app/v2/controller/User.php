...
use app\v2\model\CodeModel;
use app\v2\model\SalemanAchv;
use app\v2\validate;
...
class User extends \think\Controller {
    ...
    public function getUserInfo() {
        ...
        $User = new UserModel();
        $UserCard = new \app\v2\model\MemberCardModel();
        //用户信息
