...
export default class PCIntroduce extends React.Component{
  render(){
    return (
      <div id="aboutus_introduce">
        <PCHeader></PCHeader>
        ...
        <div className="second-floor">
          <Row>
            ...
            <Col span={14}>
              ...
              <div className="PC_cost-En">COMPANY PROFILE</div>
        ...
        <div className="third-floor">
          <Row>
            ...
            <Col span={14}>
              ...
              <div className="PC_cost-En">MILESTONE</div>
              <div className="content">
