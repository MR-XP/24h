...
app.controller('statisticaGroupController', ['$scope', '$http', '$state','$location','arrDate','$stateParams',function($scope, $http, $state,$location,arrDate,$stateParams) {
	...
	$scope.load=function(){
		...
		$http({
	        ...
	        data: {
	            ...
	            if(data.code==200){
	                $scope.statisticaGroupList=data.data;
	                if($scope.statisticaGroupList.list.length == 'undefined' || $scope.statisticaGroupList.list.length == undefined){
	                	$scope.statisticaGroupList.list = [];
	                }
	            }else{
