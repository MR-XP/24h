window.HX_CONFIG = {
    ...
    HOST			:	 	'',
    TEMPLATE_HOST	:		"static/mobile/",
    STATIC_HOST		: 		"static/mobile/",
    VERSION	   		: 		"V1",
    PAGEVERSION		:		"?v=1.7.5"
};
...
angular.module('App', ["ionic", "ngAnimate", "App.ctrls", "oc.lazyLoad", "App.filters", "App.directives","App.services"])
    ...
    .config(["$stateProvider", "$urlRouterProvider", "$ionicConfigProvider", function ($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
		...
		.state('users', {
			...
			.state('users.quiz', {
				url: '/quiz',
				templateUrl: HX_CONFIG.TEMPLATE_HOST + "tpl/users/quiz.html"+HX_CONFIG.PAGEVERSION,
				cache: false
			})
			...
			//公共课列表
			.state('users.groupCourse-list', {
				url: '/groupCourse-list',
				templateUrl: HX_CONFIG.TEMPLATE_HOST + "tpl/users/groupCourse-list.html"+HX_CONFIG.PAGEVERSION,
				cache: false
			})
