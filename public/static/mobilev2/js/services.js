	...
	var methodMap = {
	   ...
	   //公用模块
        ...
        //用户端
        	...
        	//课程模块
        	getPlanCourseList	    : {url : HX_CONFIG.VERSION+'/plan/search', method : 'post'},						 	 //排课列表
    		...
    		planRec				    : {url : HX_CONFIG.VERSION+'/plan/planRec', method : 'post'},				 	         //排课推荐
            ...
            getCourseList           : {url : HX_CONFIG.VERSION+'/course/getList'  , method : 'post'},                        //小团课列表


            //评价
            courseComment           : {url : HX_CONFIG.VERSION+'/comment/courseComment'  , method : 'post'},                 //评价
            getcommentList          : {url : HX_CONFIG.VERSION+'/comment/getList'  , method : 'post'},                       //评价列表
            ...
            CoachComment            : {url : HX_CONFIG.VERSION+'/comment/CoachComment'  , method : 'post'},                  //会员评价
			coachRec			    : {url : HX_CONFIG.VERSION+'/coach/coachRec'  , method : 'post'},				 	     //私教推荐
